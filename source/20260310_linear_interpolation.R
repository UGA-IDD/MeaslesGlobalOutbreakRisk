...
# "radial_mean_month", "radial_sd_month", "outcome_ivb"
...
df_interpolate_constant_shift_linear_lag <- lag_monthly_data(df_interpolate_constant_shift_linear, "iso3","year", "month", 
                                                c("average_age_suspected_cases", "extreme_precipitation_high_2SD", "extreme_precipitation_high_3SD", 
                                                  ...
                                                  "igm_negative_cases", "mean_precipitation", "mean_temperature",
                                                  "measles_igm_positive_cases", "proportion_igm_measles_pos", 
                                                  "proportion_igm_mr_neg", "proportion_igm_rubella_pos", 
                                                  "rubella_igm_positive_cases", "suspected_cases", "total_precipitation",
                                                  "radial_mean_month", "radial_sd_month",
                                                  "cv_cases", "case_range_adm1"), 1)


#### 6 month lag 
df_interpolate_constant_shift_linear_lag <- lag_monthly_data(df_interpolate_constant_shift_linear_lag, "iso3","year", "month", 
                                                c("battle_mr", "district_stockout", "estimated_infections", "estimated_infections_minor_leakage", "gdp_pc", "hdi", "hiv", "health_expenditure", "land_dispute_index",
                                                  "idp", "malaria", "mcv1",  "mcv2", "mcv2_intro", "national_stockout", "prop_estimated_infections_under10",
                                                  ...
                                                  "rcv_intro", "school_based_immunization", "stockout_duration", "stunting", "underweight", "vitA_campaign", "vitA_routine","wasting", "seroprevalence_under5s", "seroprevalence_over5s"), 6)
...
fwrite(df_interpolate_constant_shift_linear, file = paste0('~/Google Drive/My Drive/Gates_MeaslesForecast/updates_jhu/df_interpolate_linear_20260310.csv'))
fwrite(df_interpolate_constant_shift_linear_lag, file = paste0('~/Google Drive/My Drive/Gates_MeaslesForecast/updates_jhu/df_interpolate_linear_lag_20260310.csv'))
